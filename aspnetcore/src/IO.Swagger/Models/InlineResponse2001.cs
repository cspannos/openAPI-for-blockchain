...
{ 
    ...
    { 
        ...
        /// <summary>
        /// Sometimes called the network id, this number discerns the active chain for the BeaconNode. Analagous to Eth1.0 JSON-RPC net_version.
        /// </summary>
        /// <value>Sometimes called the network id, this number discerns the active chain for the BeaconNode. Analagous to Eth1.0 JSON-RPC net_version.</value>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Fork != null)
                    hashCode = hashCode * 59 + Fork.GetHashCode();
                    if (ChainId != null)
                    hashCode = hashCode * 59 + ChainId.GetHashCode();
                return hashCode;
            }
        }
