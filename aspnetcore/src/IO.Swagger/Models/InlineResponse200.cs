...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <value>A boolean of whether the node is currently syncing or not.</value>
        [DataMember(Name="is_syncing")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsSyncing: ").Append(IsSyncing).Append("\n");
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (IsSyncing != null)
                    hashCode = hashCode * 59 + IsSyncing.GetHashCode();
                    if (SyncStatus != null)
